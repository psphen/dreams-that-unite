            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">A</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">B</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">C</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">D</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">F</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">G</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">H</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">I</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">J</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">K</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">L</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">M</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">N</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">O</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">P</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">Q</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">R</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">S</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">T</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">U</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">V</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">W</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">X</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">Y</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2 col-6 my-2">
                <div class="service-box-10">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center mb-0">Z</h5>
                        </div>
                    </div>
                </div>
            </div>
